...
REPO="${1:-$HOME/lamina}"
export CARGO_TARGET_DIR="$HOME/.lamina-bridge-target"
...
cp "$HOME/.lamina-bridge-target/release/lamina-bridge" "$REPO/validation/lamina_bridge/target/release/" 2>/dev/null || true
